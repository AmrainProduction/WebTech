...
$queryBooks = $mysql->query('SELECT books.id, books.preview, books.name_book, id_author.surname, id_author.name, books.description, books.price FROM books INNER JOIN id_author ON books.id_author=id_author.id');
