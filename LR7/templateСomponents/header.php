...
<div class="wrapper-header-bottom">
    <div class="header-bottom d-flex justify-content-between align-items-center">
        <a href="./list.php" class="col-md-1 d-flex justify-content-center align-items-center">Акции</a>
        ...
        <a href="./exportImport.php" class="col-md-1 d-flex justify-content-center align-items-center">Подробки</a>
